...
-   /callback - Handles incoming oAuth2 requests and if the authentication is successful -> logs that user's **email and IP address** through the provided webhook -> saves into the database
